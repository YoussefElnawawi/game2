...
TIME_FONT = pygame.font.SysFont('comicsans', 35)
...
def draw_window(red, yellow, red_bullets, yellow_bullets, red_health, yellow_health, time_remaining):
    ...
    time_remaining_text = TIME_FONT.render(str(time_remaining), 1, WHITE)

    WIN.blit(time_remaining_text, (WIDTH/2 - time_remaining_text.get_width() /
                         2,12))
...
def main():
    ...
    while run:
        ...
        draw_window(red, yellow, red_bullets, yellow_bullets,
                    red_health, yellow_health, time_remaining)
